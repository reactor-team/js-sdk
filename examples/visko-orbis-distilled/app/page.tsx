import { ViskoOrbisDistilledApp } from "./ViskoOrbisDistilledApp";
...
//   - present      → <ViskoOrbisDistilledApp />, which fetches the JWT itself
//
...
export default function Page() {
  ...
  return hasKey ? <ViskoOrbisDistilledApp /> : <SetupRequired />;
}
