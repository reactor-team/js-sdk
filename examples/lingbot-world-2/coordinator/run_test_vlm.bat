...
wsl -e bash -lc "cd /mnt/c/workspace/world/REACTOR_js-sdk/examples/lingbot-world-2/coordinator && NVIDIA_API_KEY='%NVIDIA_API_KEY%' /home/kschmid/lingbot-venv/bin/python test_vlm_image.py %*"
endlocal
