...
| [`xmax/`](./xmax)                       | [`@reactor-team/js-sdk`](https://www.npmjs.com/package/@reactor-team/js-sdk) (generic; no typed model package) | Streaming **V2V editor** on XMAX X2. Live webcam or file-clip editing via manual `camera` publish with side-by-side compare, mid-stream re-prompting, snap-clip recording.                                                                                                         |
