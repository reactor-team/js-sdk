...
| [`lingbot-world-2/`](./lingbot-world-2)         | [`@reactor-models/lingbot-world-2`](https://www.npmjs.com/package/@reactor-models/lingbot-world-2)         | **LingBot World 2** public demo. Two-axis WASD driving (`set_move_longitudinal` + `set_move_lateral`, diagonals included), curated `set_camera_pose` presets (orbit, push-in, crane), dynamic world events as live prompt swaps, `chunk N / total` run progress, snap-clip recording.    |
