...
| [`lingbot-2/`](./lingbot-2)           | [`@reactor-models/lingbot`](https://www.npmjs.com/package/@reactor-models/lingbot) (skeleton; pending `@reactor-models/lingbot-2`) | **Lingbot 2** public-demo skeleton. Faithful mirror of `lingbot/` rebranded for the next model version. Typed `@reactor-models/lingbot-2` package is not published yet (REA-3595), so it reuses the published `@reactor-models/lingbot` SDK until the v2 package ships.            |
...
npx create-reactor-app my-app --model lingbot-2
