import { ViskoOrbisDynamicApp } from "./ViskoOrbisDynamicApp";
...
//   - present      → <ViskoOrbisDynamicApp />, which fetches the JWT itself
//
...
export default function Page() {
  ...
  return hasKey ? <ViskoOrbisDynamicApp /> : <SetupRequired />;
}
